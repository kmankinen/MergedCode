...
def analyze(config):
    ...
    loop += ssdilep.algs.ObjWeights.MuFakeFactor(
            config_file=os.path.join(main_path,'ssdilep/data/g_ff.root'),
            mu_index=0,
            key='MuLeadFF',
            scale=None,
            )
    ...
    loop += ssdilep.algs.algs.PlotAlg(
            ...
            plot_all  = False,
            cut_flow  = [
              ['AtLeastTwoMuons',None],
              ['MuTrigMatch',None],
              ['MuTrigPass',['SingleMuonTrigSF']],
              #['MuPairsDeltaRJet04', None],
              ['MuPairsMVis15',None],
              ['MuPairsMZwindow',None],
              ['MuPairsAreOS',None],
              ['MuPairsLeadPt25SubLeadPt22',None],
              ['MuPairsIsoTight', ['MuPairsAllTightSF']],
              ],
            )
    
    ## mumu den tight-loose
    ## ---------------------------------------
    loop += ssdilep.algs.algs.PlotAlg(
            region    = 'SIG_DEN_TL',
            obj_keys  = ['mu_pairs'], # make obj cutflow for just these objects
            ...
            cut_flow  = [
              ...
              ['MuPairsAreOS',None],
              ['MuPairsLeadPt25SubLeadPt22',None],
              ['MuPairsLeadIsoTightSubLeadIsoNotTight',['MuPairsLeadTightSubLeadNotTightAllSF','MuPairsSubLeadFF']],
              #['MuPairsSubLeadTruthFilter', None],
              ],
            )
    
    ## mumu den loose-tight
    ## ---------------------------------------
    loop += ssdilep.algs.algs.PlotAlg(
            region    = 'SIG_DEN_LT',
            obj_keys  = ['mu_pairs'], # make obj cutflow for just these objects
            ...
            cut_flow  = [
              ...
              ['MuPairsAreOS',None],
              ['MuPairsLeadPt25SubLeadPt22',None],
              ['MuPairsLeadIsoNotTightSubLeadIsoTight', ['MuPairsLeadNotTightSubLeadTightAllSF','MuPairsLeadFF']],
              #['MuPairsLeadTruthFilter', None],
              ],
            )
    
    ## mumu den loose-loose
    ## ---------------------------------------
    loop += ssdilep.algs.algs.PlotAlg(
            region    = 'SIG_DEN_LL',
            plot_all  = False,
            cut_flow  = [
              ...
              ['MuPairsAreOS',None],
              ['MuPairsLeadPt25SubLeadPt22',None],
              ['MuPairsLeadIsoNotTightSubLeadIsoNotTight', ['MuPairsLeadNotTightSubLeadNotTightAllSF','MuPairsLeadSubLeadFF']],
    ...
    loop += ssdilep.algs.algs.PlotAlg(
            ...
            cut_flow  = [
              ...
              ['MuTrigMatch',None],
              ['MuTruthFilter',None],
              ['SingleMuTrigPass',['SingleMuonTrigSF']],
    ...
    """
    ## di+jets control region tight-tight
    ## ---------------------------------------
    loop += ssdilep.algs.algs.PlotAlg(
            region    = 'FAKESCR_TT',
            plot_all  = False,
            cut_flow  = [
              ...
              #['LeadMuTrigMatch',None],
              #['MZwindow',None],
              ['MuTrigMatch',None],
              #['MuTruthFilter',None],
              #['MuTrigPass',['SingleMuonTrigSF']],
              #['DiMuTrigPass',['DiMuonTrigSF']],
              ['DiMuTrigPass',['DiMuonTrigSF']],
              ['LeadMuIsoTight',['MuLeadAllSF']],
              ['SubLeadMuIsoTight',['MuSubLeadAllSF']],
              #['LeadMuFar',None], 
              #['SubLeadMuFar',None], 
              #['AllMuFar',None],
              #['AllMuD0SigHigher3',None],
              #['LeadMuD0SigLess3',None],
              #['SubLeadMuD0SigLess3',None],
              #['METhigher10',None],
              ['VetoTT',None],
              ],
            )
    
    ## di+jets control region fakes loose-loose
    ## ---------------------------------------
    loop += ssdilep.algs.algs.PlotAlg(
            region    = 'FAKESCR_LL',
            plot_all  = False,
            cut_flow  = [
              ...
              ['MuTrigMatch',None],
              #['MuTruthFilter',None],
              #['MuTrigPass',['DiMuonTrigSF']],
              ['DiMuTrigPass',['DiMuonTrigSF']],
              ['LeadMuIsoNotTight',['MuLeadAllSF']],
              ['SubLeadMuIsoNotTight',['MuSubLeadAllSF']],
              #['LeadMuFar',None], 
              #['SubLeadMuFar',None], 
              #['AllMuFar',None],
              #['LeadMuClose',None], 
              #['SubLeadMuClose',None], 
              #['AllMuD0SigHigher3',None],
              #['LeadMuD0SigHigher3',None],
              #['SubLeadMuD0SigHigher3',None],
              #['METhigher10',None],
              ['VetoTT',None],
              ],
            )
    """
    """
    ## di+jets control region fakes tight-loose
    ## ---------------------------------------
    loop += ssdilep.algs.algs.PlotAlg(
            region    = 'FAKESCR_TL',
            plot_all  = False,
    ...
    ## di+jets control region fakes loose-tight
    ## ---------------------------------------
    loop += ssdilep.algs.algs.PlotAlg(
            region    = 'FAKESCR_LT',
            plot_all  = False,
    ...
    loop += ssdilep.algs.algs.PlotAlg(
            ...
            cut_flow  = [
              ['TwoSSMuons',None],
              ['M15',None],
              #['LessThanTwoJets',None],
              #['LessThanThreeJets',None],
              #['AllMuPt12',None],
              ['MuTrigMatch',None],
              #['MuTruthFilter',None],
              ['DiMuTrigPass',['DiMuonTrigSF']],
              ['LeadMuIsoTight',['MuLeadAllSF']],
              ['SubLeadMuIsoNotTight',['MuSubLeadAllSF','MuSubLeadFF']],
              #['OneMuCloseOneFar',None],
              #['LeadMuClose',None], 
              #['SubLeadMuFar',None], 
              #['VetoTL',None], 
              ],
    ...
    ## fakes validation region fakes loose-tight
    ## ---------------------------------------
    loop += ssdilep.algs.algs.PlotAlg(
            region    = 'FAKESVR_LT',
            plot_all  = False,
            cut_flow  = [
              ...
              #['MuTruthFilter',None],
              ['DiMuTrigPass',['DiMuonTrigSF']],
              ['LeadMuIsoNotTight',['MuLeadAllSF','MuSubLeadFF']],
              ['SubLeadMuIsoTight',['MuSubLeadAllSF']],
              #['OneMuCloseOneFar',None],
              #['LeadMuFar',None], 
              #['SubLeadMuClose',None], 
    ...
    """
    """
    ## fakes validation region tight-tight
    ## ---------------------------------------
    loop += ssdilep.algs.algs.PlotAlg(
            region    = 'FAKESVR_TT',
            plot_all  = False,
    ...
    ## fakes validation region fakes loose-loose
    ## ---------------------------------------
    loop += ssdilep.algs.algs.PlotAlg(
            region    = 'FAKESVR_LL',
            plot_all  = False,
            cut_flow  = [
              ...
              #['MuTruthFilter',None],
              ['DiMuTrigPass',['DiMuonTrigSF']],
              ['LeadMuIsoNotTight',['MuLeadAllSF','MuLeadFF']],
              ['SubLeadMuIsoNotTight',['MuSubLeadAllSF','MuSubLeadFF']],
              #['OneMuCloseOneFar',None],
              ['LeadMuClose',None], 
              ['SubLeadMuClose',None], 

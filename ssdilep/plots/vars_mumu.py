...
mumu_deltapt = Var(name = 'mumu_deltapt',
              path    = 'pairs',
              xmin    = 0.,
              xmax    = 400,
              rebin   = 10,
...
mumu_reldeltapt = Var(name = 'mumu_reldeltapt',
              path    = 'pairs',
              xmin    = 0.,
              xmax    = 400,
              rebin   = 10,
...
vars_list.append(probe_eta)
vars_list.append(tag_eta)
vars_list.append(probe_phi)
vars_list.append(tag_phi)
...
vars_list.append(mumu_deltapt)
vars_list.append(mumu_reldeltapt)
"""

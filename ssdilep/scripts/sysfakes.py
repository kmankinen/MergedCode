...
for i in [2,3,4,5,6,7,8]:
  hdict["SYS%s"%str(i)] = infile.Get("h_ff_FR%s"%str(i)).Clone()
...
l = ROOT.TLegend(0.2,0.65,0.7,0.9)
l.SetBorderSize(0)
l.SetFillColor(0)
l.SetFillStyle(0)
...
g_sys_ff.GetXaxis().SetTitle("p_{T}(#mu_{lead}) [GeV]")
g_sys_ff.GetYaxis().SetTitleSize(0.05)
g_sys_ff.GetXaxis().SetTitleSize(0.05)
g_sys_ff.GetYaxis().SetLabelSize(0.05)
g_sys_ff.GetXaxis().SetLabelSize(0.05)
g_sys_ff.GetYaxis().SetTitleOffset(1.2)
g_sys_ff.GetXaxis().SetTitleOffset(1.2)
g_sys_ff.GetXaxis().SetRangeUser(0.,100.)
...
g_nom_ff.GetXaxis().SetTitle("p_{T}(#mu_{lead}) [GeV]")
g_nom_ff.GetYaxis().SetTitleSize(0.05)
g_nom_ff.GetXaxis().SetTitleSize(0.05)
g_nom_ff.GetYaxis().SetLabelSize(0.05)
g_nom_ff.GetXaxis().SetLabelSize(0.05)
g_nom_ff.GetYaxis().SetTitleOffset(1.2)
g_nom_ff.GetXaxis().SetTitleOffset(1.2)
g_nom_ff.GetXaxis().SetRangeUser(0.,100.)
g_nom_ff.SetLineColor(ROOT.kBlack)
g_nom_ff.SetMarkerColor(ROOT.kBlack)
g_nom_ff.SetMarkerSize(1.3)
...
l2 = ROOT.TLegend(0.2,0.5,0.75,0.9)
l2.SetBorderSize(0)
l2.SetFillColor(0)
l2.SetFillStyle(0)

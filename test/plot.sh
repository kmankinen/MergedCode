...
python ../ssdilep/scripts/merge.py --var="mulead_pt" --reg="FAKESVR6_MAINREG" --lab="VR" --tag="test" --icut="4" --input="/coepp/cephfs/mel/fscutti/ssdilep/HistFinVR" --output="./" --makeplot=True --fakest="FullRegions"

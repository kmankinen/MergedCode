...
python ../ssdilep/scripts/merge.py --var="mulead_pt" --reg="PROBE_LOOSE" --lab="signal region" --icut="6" --input="/coepp/cephfs/mel/skeyte/ssdilep/Hist28SepFFTrigHIGG3D3" --output="./28SepFFTrigCut" --makeplot=False --fakest="Subtraction"

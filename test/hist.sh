...
INPATH="/coepp/cephfs/mel/fscutti/ssdilep/HIGG3D3_v6/merged/nominal"
...
python ${INSCRIPT}/${SCRIPT} --input ${INPATH}/physics_Main_00302380.root --sampletype="data" --events=10000 #--config="sys:FF_DN" # example of triglist probs
...
#python ${INSCRIPT}/${SCRIPT} --input ${INPATH}/Sherpa_NNPDF30NNLO_Zmumu_Pt0_70_BFilter.root  --sampletype="mc" --events=40000   #--config="sys:FF_DN" 
...
#python ${INSCRIPT}/${SCRIPT} --input ${INPATH}/Sherpa_CT10_llll.root  --sampletype="mc" --events=200   #--config="sys:FF_DN" 
